...
REM
REM Generated by Vivado on Tue Sep 23 22:43:00 +0530 2025
...
echo "xvlog --incr --relax -L uvm -prj tb_axi4_lite_top_vlog.prj"
call xvlog  --incr --relax -L uvm -prj tb_axi4_lite_top_vlog.prj -log xvlog.log
